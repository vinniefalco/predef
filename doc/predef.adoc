...
include::{includedir}/architecture/alpha.h[tag=reference]

include::{includedir}/architecture/arm.h[tag=reference]

include::{includedir}/architecture/blackfin.h[tag=reference]

include::{includedir}/architecture/convex.h[tag=reference]

include::{includedir}/architecture/e2k.h[tag=reference]

include::{includedir}/architecture/ia64.h[tag=reference]

include::{includedir}/architecture/m68k.h[tag=reference]

include::{includedir}/architecture/mips.h[tag=reference]

include::{includedir}/architecture/parisc.h[tag=reference]

include::{includedir}/architecture/ppc.h[tag=reference]

include::{includedir}/architecture/ptx.h[tag=reference]

include::{includedir}/architecture/pyramid.h[tag=reference]

include::{includedir}/architecture/riscv.h[tag=reference]

include::{includedir}/architecture/rs6k.h[tag=reference]

include::{includedir}/architecture/sparc.h[tag=reference]

include::{includedir}/architecture/superh.h[tag=reference]

include::{includedir}/architecture/sys370.h[tag=reference]

include::{includedir}/architecture/sys390.h[tag=reference]

include::{includedir}/architecture/x86.h[tag=reference]

include::{includedir}/architecture/z.h[tag=reference]

include::{includedir}/architecture/x86/32.h[tag=reference]

include::{includedir}/architecture/x86/64.h[tag=reference]
...
include::{includedir}/compiler/borland.h[tag=reference]

include::{includedir}/compiler/clang.h[tag=reference]

include::{includedir}/compiler/comeau.h[tag=reference]

include::{includedir}/compiler/compaq.h[tag=reference]

include::{includedir}/compiler/diab.h[tag=reference]

include::{includedir}/compiler/digitalmars.h[tag=reference]

include::{includedir}/compiler/dignus.h[tag=reference]

include::{includedir}/compiler/edg.h[tag=reference]

include::{includedir}/compiler/ekopath.h[tag=reference]

include::{includedir}/compiler/gcc.h[tag=reference]

include::{includedir}/compiler/gcc_xml.h[tag=reference]

include::{includedir}/compiler/greenhills.h[tag=reference]

include::{includedir}/compiler/hp_acc.h[tag=reference]

include::{includedir}/compiler/iar.h[tag=reference]

include::{includedir}/compiler/ibm.h[tag=reference]

include::{includedir}/compiler/intel.h[tag=reference]

include::{includedir}/compiler/kai.h[tag=reference]

include::{includedir}/compiler/llvm.h[tag=reference]

include::{includedir}/compiler/metaware.h[tag=reference]

include::{includedir}/compiler/metrowerks.h[tag=reference]

include::{includedir}/compiler/microtec.h[tag=reference]

include::{includedir}/compiler/mpw.h[tag=reference]

include::{includedir}/compiler/nvcc.h[tag=reference]

include::{includedir}/compiler/palm.h[tag=reference]

include::{includedir}/compiler/pgi.h[tag=reference]

include::{includedir}/compiler/sgi_mipspro.h[tag=reference]

include::{includedir}/compiler/sunpro.h[tag=reference]

include::{includedir}/compiler/tendra.h[tag=reference]

include::{includedir}/compiler/visualc.h[tag=reference]

include::{includedir}/compiler/watcom.h[tag=reference]
...
include::{includedir}/language/cuda.h[tag=reference]

include::{includedir}/language/objc.h[tag=reference]

include::{includedir}/language/stdc.h[tag=reference]

include::{includedir}/language/stdcpp.h[tag=reference]
...
include::{includedir}/library/c/cloudabi.h[tag=reference]

include::{includedir}/library/c/gnu.h[tag=reference]

include::{includedir}/library/c/uc.h[tag=reference]

include::{includedir}/library/c/vms.h[tag=reference]

include::{includedir}/library/c/zos.h[tag=reference]

include::{includedir}/library/std/cxx.h[tag=reference]

include::{includedir}/library/std/dinkumware.h[tag=reference]

include::{includedir}/library/std/libcomo.h[tag=reference]

include::{includedir}/library/std/modena.h[tag=reference]

include::{includedir}/library/std/msl.h[tag=reference]

include::{includedir}/library/std/roguewave.h[tag=reference]

include::{includedir}/library/std/sgi.h[tag=reference]

include::{includedir}/library/std/stdcpp3.h[tag=reference]

include::{includedir}/library/std/stlport.h[tag=reference]

include::{includedir}/library/std/vacpp.h[tag=reference]
...
include::{includedir}/os/aix.h[tag=reference]

include::{includedir}/os/amigaos.h[tag=reference]

include::{includedir}/os/beos.h[tag=reference]

include::{includedir}/os/bsd.h[tag=reference]

include::{includedir}/os/cygwin.h[tag=reference]

include::{includedir}/os/haiku.h[tag=reference]

include::{includedir}/os/hpux.h[tag=reference]

include::{includedir}/os/ios.h[tag=reference]

include::{includedir}/os/irix.h[tag=reference]

include::{includedir}/os/linux.h[tag=reference]

include::{includedir}/os/macos.h[tag=reference]

include::{includedir}/os/os400.h[tag=reference]

include::{includedir}/os/qnxnto.h[tag=reference]

include::{includedir}/os/solaris.h[tag=reference]

include::{includedir}/os/unix.h[tag=reference]

include::{includedir}/os/vms.h[tag=reference]

include::{includedir}/os/windows.h[tag=reference]

include::{includedir}/os/bsd/bsdi.h[tag=reference]

include::{includedir}/os/bsd/dragonfly.h[tag=reference]

include::{includedir}/os/bsd/free.h[tag=reference]

include::{includedir}/os/bsd/net.h[tag=reference]

include::{includedir}/os/bsd/open.h[tag=reference]
...
include::{includedir}/platform/android.h[tag=reference]

include::{includedir}/platform/cloudabi.h[tag=reference]

include::{includedir}/platform/ios.h[tag=reference]

include::{includedir}/platform/mingw.h[tag=reference]

include::{includedir}/platform/mingw32.h[tag=reference]

include::{includedir}/platform/mingw64.h[tag=reference]

include::{includedir}/platform/windows_desktop.h[tag=reference]

include::{includedir}/platform/windows_phone.h[tag=reference]

include::{includedir}/platform/windows_runtime.h[tag=reference]

include::{includedir}/platform/windows_server.h[tag=reference]

include::{includedir}/platform/windows_store.h[tag=reference]

include::{includedir}/platform/windows_system.h[tag=reference]

include::{includedir}/platform/windows_uwp.h[tag=reference]
...
include::{includedir}/hardware/simd.h[tag=reference]

include::{includedir}/hardware/simd/arm.h[tag=reference]

include::{includedir}/hardware/simd/arm/versions.h[tag=reference]

include::{includedir}/hardware/simd/ppc.h[tag=reference]

include::{includedir}/hardware/simd/ppc/versions.h[tag=reference]

include::{includedir}/hardware/simd/x86.h[tag=reference]

include::{includedir}/hardware/simd/x86/versions.h[tag=reference]

include::{includedir}/hardware/simd/x86_amd.h[tag=reference]

include::{includedir}/hardware/simd/x86_amd/versions.h[tag=reference]
...
include::{includedir}/other/endian.h[tag=reference]

include::{includedir}/other/wordsize.h[tag=reference]

include::{includedir}/other/workaround.h[tag=reference]
...
include::{includedir}/version_number.h[tag=reference]

include::{includedir}/make.h[tag=reference]
...
include::example$history.adoc[]

include::example$todo.adoc[]
